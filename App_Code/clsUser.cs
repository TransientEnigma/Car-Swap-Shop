...
public class clsUser
{
    ...
    string mLastName;
    //declare a connection to the database using the new clsDataConnectionDB class
    clsDataConnectionOLDB oldbUsers;

    //this line of code became obsolete due to introduction of clsDataConnectionOLDB
